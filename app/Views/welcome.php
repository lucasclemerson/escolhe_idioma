...
<header>
    ...
    <div class="heroe">
        <h1>Bem vindo a minha página feita com o CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
        <h2>Uma pequena demostração de troca de idioma</h2>
    </div>
</header>
...
<section>
    ...
    <p>A página é totalmente feita com o Framework CodeIgniter.</p>
    <p>Para a customização dessa página basta editar o arquivo que se encontra em:</p>
    <pre><code>app/Views/welcome.php</code></pre>
    <p>Junto também de seu Controller:</p>
...
<footer>
    <div class="copyrights">
        <p>&copy; <?= date('Y') ?> Todos os diretor Reservados.</p>
    </div>
</footer>
<!-- SCRIPTS -->
<script>
